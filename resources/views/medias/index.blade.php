                    ...
                    <div class="ml-auto d-inline-flex">
                        <li class="nav-item">
                            <div style="width: 200px;" id="selectCollection" class="ml-auto pb-2 mx-2">
                                <select name="collection_name" id="collectionName" class="form-control-sm form-control "> </select>
                            </div>
                        </li>
                        <li class="nav-item">
            ...
            <div class="card-body">
                ...
                <div id="createMediaField" class="row">
                    <div class="col-12">
                        ...
                        <a href="#" id="doneMedia" class="btn btn-outline-primary btn-sm float-right mt-1">{{ trans('lang.done')}}</a>
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function initSelectCollection() {
            ...
            $.ajax({
                ...
                success: function (data, status) {
                    ...
                    select.val('image').trigger('change');
                }
            });
        }
        ...
        $('#mediaModal #refreshMedia').on('click', function () {
            loadMedia("{!! url('uploads/all') !!}/image");
        ...
        $('#mediaModal #collectionName').on('change', function () {
