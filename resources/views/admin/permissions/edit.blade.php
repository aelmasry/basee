    ...
    <div class="card">
        <div class="card-header">
            <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{!! route('admin.permissions.edit',$permission->id) !!}"><i class="fa fa-pencil mr-2"></i>{{trans('lang.permission_edit')}}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{!! route('admin.roles.index') !!}"><i class="fa fa-list mr-2"></i>{{trans('lang.role_table')}}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{!! route('admin.roles.create') !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.role_create')}}</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
