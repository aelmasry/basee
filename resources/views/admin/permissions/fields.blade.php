...
<div class="form-group col-sm-12 text-right">
    <button type="submit" class="btn btn"><i class="fa fa-save"></i> {{trans('lang.save')}} {{trans('lang.permission')}}</button>
    <a href="{!! url('admin/permissions') !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.cancel')}}</a>
</div>
