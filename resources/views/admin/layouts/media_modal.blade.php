        ...
        <div class="modal-content">
            <div class="modal-header align-items-stretch">
                ...
                <div id="resizeItems" class="ml-auto btn-group">
                    <button type="button" data-size="2" class="btn btn-outline-secondary"><i
                            class="fa fa-th"></i></button>
                    <button type="button" data-size="3" class="btn btn-primary"><i class="fa fa-th-large"></i></button>
                    <button type="button" data-size="4" class="btn btn-outline-secondary"><i
...
<script type="text/javascript">
    ...
    var triggerButton;
        ...
        */
        ...
        $('#mediaModal #collection_name').on('change',function () {
